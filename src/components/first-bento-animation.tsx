...
export function ReasoningBasic() {
  const reasoningText = `To verify the identity quickly and accurately, I recommend using our Trusted Records Database. It has the most up-to-date information and the highest reliability score for background checks. This will ensure fast and secure verification without delays.`;
